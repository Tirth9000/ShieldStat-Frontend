          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex justify-between items-center mb-10 border-b border-gray-800 pb-6">
              <div className="mt-4">
                ...
                <p className="text-gray-600 text-sm mt-1">
                  ID: <span className="font-mono text-gray-500">{data._id}</span>{" "}
                  • Date: {new Date(data.createdAt).toLocaleDateString()}
                </p>
              </div>

              {/* REMOVED THE CHECK HERE: Button will now always show */}
              <div>
                <button
                  className="bg-blue-600 px-6 py-2 rounded-full font-semibold hover:bg-blue-700 transition"
                  onClick={() => router.push("/assessments/SecurityAssessment/")}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <div
                    className={`text-3xl font-black uppercase tracking-wide ${riskColors.text}`}
                  >
                    {data.risk_level}
                  </div>
                </div>
