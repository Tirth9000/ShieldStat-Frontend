      ...
      <main className="flex-grow flex flex-col items-center justify-center w-full min-h-screen py-20">
        ...
        <div className="flex flex-col items-center justify-center text-center px-4 w-full max-w-5xl">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 mt-8">
            <span className="text-white">Cyber Reconnaissance</span>
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            ...
            <Link href="/demoPage">
              <button className="px-8 py-3.5 border border-white/10 bg-white/5 backdrop-blur-md text-white font-semibold rounded-lg hover:bg-white/10 transition-all hover:-translate-y-1 cursor-pointer">
                Book Demo
              </button>
            </Link>
          </div>
