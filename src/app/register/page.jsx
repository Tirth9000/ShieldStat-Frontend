...
export default function RegisterPage() {
  ...
  // FIX 1: Use e.target.name so it grabs the correct input field name
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#0a0f1c] relative overflow-hidden text-slate-300 font-sans">
      ...
      <div className="z-10 w-full max-w-md p-8 bg-[#111827]/80 backdrop-blur-sm border border-slate-800 rounded-2xl shadow-2xl">
